<!-- Campaign record. Moved out of the Claude memory store 2026-08-05; the
     memory file was `project_hm0_spike_rootcause`. -->
...
4. Deferred mask/boundary cleanups — see project_mask_boundary_cleanups (memory retired 2026-07-25).

Related: [[project_snapwave_root_cause]], project_noaa_boundary (memory retired 2026-07-25), [[project_coned_upgrade]], [[project_compound_roadmap]], project_quadtree_session (memory retired 2026-07-25).

<!-- Campaign record. Moved out of the Claude memory store 2026-08-05; the
     memory file was `project_coned_upgrade`. -->
...
>
> **Standing summary at the time of the move:** Elevation stack upgrade for the Sandy hindcast — pre-Sandy 1 m topobathy added as top layer, grid refined to 50 m. Completed 2026-05-13.


Upgrade to the [[project_nj_sandy]] elevation stack — completed 2026-05-13.

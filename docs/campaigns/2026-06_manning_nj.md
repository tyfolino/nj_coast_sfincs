<!-- Campaign record. Moved out of the Claude memory store 2026-08-05; the
     memory file was `project_manning_nj`. -->
...
>
> **Standing summary at the time of the move:** NJ Sandy SFINCS — NLCD→Manning's n reclass table (Bunya/Atkinson Atlantic-coast values, with class-23/24 NJ tuning); replaces hydromt-sfincs's shipped SFBD-tuned default
...
Related: [[project_compound_roadmap]] (Phase 2 status), [[project_nj_framework]]
